...
stateRoutes.get("/research-notes", async (_req, res) => {
  try {
    ...
    const phases = ["brainstorm", "research", "architecture", "environment", "tasks", "coding"];
...
stateRoutes.post("/research-notes", async (req, res) => {
  try {
    ...
    const validPhases = ["brainstorm", "research", "architecture", "environment", "tasks", "coding"];
